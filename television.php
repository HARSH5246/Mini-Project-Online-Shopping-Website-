...
<body>
            ...
            <div class="col-lg-3"> <!-- Mobiles sidebar Content(Filtering) -->
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input product_check" value="<?= $row['SpeakerOutput']; ?>" id="speakerOutput"><?= $row['SpeakerOutput']; ?>
                            </label>
                        </div>
                    </li>
                    <?php } ?>
   ...
   <!-- Modal: modalAbandonedCart--><!-- Popup Open-->
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-9" id="popupDetails">
                            ...
                            <p id="popupResolutionTel"></p>
                            <p id="popupSize"></p>
                            <p id="popupspeakerOutput"></p>
                            <p id="popupPorts"></p>
                            <h5 id="popupPrice"></h5>
                            <p id="popupCode"></p>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var resolutionpop = document.getElementById('popupResolutionTel');
        var sizepop = document.getElementById('popupSize');
        var speakerOutputpop = document.getElementById('popupspeakerOutput');
        var portspop = document.getElementById('popupPorts');
        ...
        function showpopup(x) {
            ...
            resolutionpop.innerHTML = x.parentElement.getAttribute('data-resolution');

            sizepop.innerHTML = x.parentElement.getAttribute('data-size');

            speakerOutputpop.innerHTML = x.parentElement.getAttribute('data-speakerOutput') + " Speaker Output";

            portspop.innerHTML = x.parentElement.getAttribute('data-ports');
        ...
        $(document).ready(function() {
            $(".product_check").click(function() {
                ...
                var speakerOutput = get_filter_text('speakerOutput');
