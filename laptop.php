...
<body>
    ...
    <div class="container-fluid">
        <div class="row"> <!-- Laptops Content -->
            <div class="col-lg-3"> <!-- Laptops sidebar Content(Filtering) -->
                ...
                <br>
                <h6 class="text-muted text-center">Select Storage</h6>
                <ul class="list-group">
                    <?php
            ...
            </div>  <!-- Laptops sidebar Content(Filtering) End -->
            
            <div class="col-lg-9">  <!-- Laptops Main Content(Products) -->
            ...
            </div> <!-- Laptops Main Content(Products) End-->
        </div> <!-- Laptops Content End -->
