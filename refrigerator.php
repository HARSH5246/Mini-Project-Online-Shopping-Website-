...
<body>
            ...
            <div class="col-lg-3"> <!-- Mobiles sidebar Content(Filtering) -->
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input product_check" value="<?= $row['Weight']; ?>" id="weight"><?= $row['Weight']; ?>
                            </label>
                        </div>
                    </li>
                    <?php } ?>
   ...
   <!-- Modal: modalAbandonedCart--><!-- Popup Open-->
    ...
    <script type="text/javascript">
        ...
        var volumepop = document.getElementById('popupVolume');
        var typepop = document.getElementById('popupType');
        var dimensionspop = document.getElementById('popupDimensions');
        var weightpop = document.getElementById('popupWeight');
        ...
        function showpopup(x) {
            ...
            volumepop.innerHTML = x.parentElement.getAttribute('data-volume');

            typepop.innerHTML = x.parentElement.getAttribute('data-type');

            dimensionspop.innerHTML = x.parentElement.getAttribute('data-dimensions');

            weightpop.innerHTML = x.parentElement.getAttribute('data-weight');
         ...
         function setCatg(x)
           { 
            ...
            $("#search").keyup(function(){
                ...
                var action = 'filterRefrigerators';
               $.ajax({
                    url: 'action.php',
                    type: 'POST',
                    data: {
