...
<body>
    ...
    <header>
        <!-- Header Start -->
        <!-- First Navbar -->
        <nav class="navbar navbar-expand-lg fixed-top navbar-light bg-warning" id="firstnav">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light" id="secondtop">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent1">
                <ul class="navbar-nav ml-auto mr-auto">
                    <li class="nav-item ">
                        <a class="nav-link btn btn-success" href="#">Welcome Guest</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
                          ...
                          <a class="dropdown-item" href="powerbank.php">Power Banks</a>
                          <a class="dropdown-item" href="television.php">Television</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-primary" href="contactus.php">
    ...
    <div id="demo" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="Images/flip6.jpg" alt="Los Angeles" width="1100" height="500">
                <div class="carousel-caption">

                </div>
            </div>
            <div class="carousel-item">
                <img src="Images/man.jpg" alt="Chicago" width="1100" height="500">
                <div class="carousel-caption">
